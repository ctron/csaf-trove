        ...
        <div class="flex items-center mt-6 text-center border rounded-lg h-96 dark:border-gray-700">
            <div class="flex flex-col w-full max-w-sm px-4 mx-auto">
                ...
                <div class="flex items-center justify-center mt-4 sm:mx-auto gap-x-3">
                    <button type="button" on:click=on_click class="w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
                        {action_label}
                    </button>
                </div>
            </div>
